    ...
    <div className={`w-48 md:w-56 bg-white border-r border-gray-200 flex flex-col ${className}`}>
      ...
      <div className="p-3 border-b border-gray-200">
        ...
        <div className="space-y-0.5 mb-3">
          <div className="flex items-center justify-between py-1.5 px-2 hover:bg-gray-50 rounded text-sm cursor-pointer">
          ...
          <div className="flex items-center justify-between py-1.5 px-2 hover:bg-gray-50 rounded text-sm cursor-pointer">
            ...
            <span className="text-xs bg-gray-200 text-gray-600 px-1.5 py-0.5 rounded">36</span>
          </div>
          <div className="flex items-center justify-between py-1.5 px-2 hover:bg-gray-50 rounded text-sm cursor-pointer">
            <div className="flex items-center space-x-2">
              <svg className="w-3.5 h-3.5 text-gray-600" fill="currentColor" viewBox="0 0 24 24">
            ...
            <span className="text-xs bg-gray-200 text-gray-600 px-1.5 py-0.5 rounded">5</span>
          </div>
        </div>
        ...
        <div className="mb-3">
          ...
          <div className="space-y-0.5">
            <div className="flex items-center justify-between py-1 px-2 hover:bg-gray-50 rounded text-sm cursor-pointer">
              <div className="flex items-center space-x-2">
